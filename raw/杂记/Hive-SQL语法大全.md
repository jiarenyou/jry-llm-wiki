...
## 相关笔记
- [[DataLab 基于LLM的统一BI平台]]：LLM驱动的BI平台中SQL自动生成的实际应用场景
- [[数仓建模：核心方法]]：数仓建模理论中大量使用Hive SQL进行数据分层处理
- [[数据治理之服务水平协议（SLA）]]：数据治理中SQL是基础工具，SLA保障数据质量
- [[spark性能优化1：性能优化全景图]]：Spark SQL优化与Hive SQL的性能调优有共通之处
