...
⬅️ 上一课：[[第6课 手写 Inference.py 大模型代码逻辑|第6课 Inference.py]] | 下一课：[[第8课 KV Cache 原理讲解|第8课 KV Cache]] ➡️
...
标准的自注意力机制计算过程如下（关于 QKV 矩阵的含义，参见 [[transformer中QKV矩阵分别代表什么]]）：
...
- **FlashAttention 2**:
  ...
  - 性能比 V1 更快。
  - 原生支持 **MQA (Multi-Query Attention)** 和 **GQA (Grouped-Query Attention)**。相关内容详见 [[第8课 KV Cache 原理讲解]] 中关于 KV Cache 优化的部分。
