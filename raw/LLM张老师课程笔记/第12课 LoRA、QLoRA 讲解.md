...
⬅️ 上一课：[[第11课 Sinusoidal、RoPE、ALiBi等各类位置信息编码|第11课 位置编码]] | 下一课：[[第13课 GPTQ、AWQ、GGUF等模型量化概念讲解|第13课 模型量化]] ➡️
...
`Hugging Face` 的 **PEFT (Parameter-Efficient Fine-Tuning)** 库是应用 LoRA 的主流工具。对于实际动手操作，可以参考 [[Xtuner：大模型微调快速上手]]。
