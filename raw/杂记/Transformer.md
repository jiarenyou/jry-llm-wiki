...
学习资料：
	...
	[[第1课 什么是线性变换 Linear Transformation|空间变换]]
...
## 相关笔记
- 关于Transformer中QKV矩阵的具体含义，参见[[transformer中QKV矩阵分别代表什么]]
- 使用PyTorch实现Transformer的入门教程，参见[[pytorch初级]]
- 对Transformer和MoE混合专家架构的思考，参见[[关于Transformer和MoE框架的一点思考]]
- Transformer注意力机制的优化方案，参见[[第7课 Flash Attention 原理讲解]]
- Transformer在检索增强生成中的应用，参见[[面向知识的检索-增强生成综述]]